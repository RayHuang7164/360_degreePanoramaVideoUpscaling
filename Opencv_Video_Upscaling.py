...
out = cv2.VideoWriter(f"D:/Python/output.mp4", fourcc, fps, (new_width, new_height))
...
#===================加載聲音=======================
# 加载原始视频文件
video_with_audio = mp.VideoFileClip(f"D:/Python/{fileName}.mp4")
...
final_video = mp.VideoFileClip(f"D:/Python/output.mp4").set_audio(audio)

# 保存最终的视频文件
final_video.write_videofile(f"D:/Python/{fileName}_final_output.mp4")
